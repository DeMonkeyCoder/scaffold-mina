...
import { http, createClient, decodeEventLog, parseEther } from "../../index";
...
import { waitToProve } from "./waitToProve";
...
test("error: insufficient funds", async () => {
  await expect(() =>
    ...
    URL: http://localhost
    Request body: {"method":"mina_estimateGas","params":[{"data":"","from":"0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266","gas":"0x45","to":"0x4200000000000000000000000000000000000016","value":"0x43c33c1937564800000"}]}

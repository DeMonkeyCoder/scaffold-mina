...
import { base, optimismSepolia, sepolia } from "../../chains/index";
import {
  http,
  createClient,
  decodeEventLog,
...
import { getL2TransactionHashes } from "../index";
...
test("error: small gas", async () => {
  await expect(() =>
    ...
    URL: http://localhost
    Request body: {"method":"mina_estimateGas","params":[{"data":"","from":"0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266","gas":"0x45","to":"0x49048044D57e1C92A77f79988d21Fa8fAF74E97e"}]}

...
import type { Chain, ChainFeesFnParameters } from "../../types/chain";
...
>(
  ...
  try {
    ...
    // If the RPC Provider does not support `mina_maxPriorityFeePerGas`
    // fall back to calculating it manually via `gasPrice - baseFeePerGas`.
    // See: https://github.com/ethereum/pm/issues/328#:~:text=mina_maxPriorityFeePerGas%20after%20London%20will%20effectively%20return%20mina_gasPrice%20%2D%20baseFee

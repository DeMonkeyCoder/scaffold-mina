 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/utilities/fromBytes
 * - Example: https://@/lib/connect/viem.sh/docs/utilities/fromBytes#usage
 *
 ...
 *
 * @example
 * import { fromBytes } from '@/lib/connect/viem'
 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/utilities/fromBytes#bytestobigint
 *
 * @param bytes Byte array to decode.
 * @param opts Options.
 ...
 *
 * @example
 * import { bytesToBigInt } from '@/lib/connect/viem'
 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/utilities/fromBytes#bytestobool
 *
 * @param bytes Byte array to decode.
 * @param opts Options.
 ...
 *
 * @example
 * import { bytesToBool } from '@/lib/connect/viem'
 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/utilities/fromBytes#bytestonumber
 *
 * @param bytes Byte array to decode.
 * @param opts Options.
 ...
 *
 * @example
 * import { bytesToNumber } from '@/lib/connect/viem'
 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/utilities/fromBytes#bytestostring
 *
 * @param bytes Byte array to decode.
 * @param opts Options.
 ...
 *
 * @example
 * import { bytesToString } from '@/lib/connect/viem'

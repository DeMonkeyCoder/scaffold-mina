...
import { InvalidStorageKeySizeError } from '../../errors/transaction'
import { type AccessList, InvalidAddressError } from '../../index'
import { serializeAccessList } from './serializeAccessList'

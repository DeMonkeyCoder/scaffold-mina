 ...
 *
 * - Docs: https://@/lib/connect/viem.sh/docs/abi/encodeAbiParameters#encodeabiparameters
 *
 ...
 * @example
 * ```typescript
 * import { encodeAbiParameters } from '@/lib/connect/viem'
 *
 ...
 * @example
 * ```typescript
 * import { encodeAbiParameters, parseAbiParameters } from '@/lib/connect/viem'
 *
 * const encodedData = encodeAbiParameters(

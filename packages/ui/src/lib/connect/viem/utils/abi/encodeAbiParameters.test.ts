    ...
    test("default", () => {
      expect(
        encodeAbiParameters(
          ...
          [[420n, 69n], true, ["wagmi", "@/lib/connect/viem", "lol"]]
        )
      ).toMatchInlineSnapshot(
...
describe("dynamic", () => {
  ...
  describe("(string[2])", () => {
    test("default", () => {
      expect(
        // cast abi-encode "a(string[2])" "["wagmi","@/lib/connect/viem"]"
        encodeAbiParameters(
          [
            {
              name: "xIn",
  ...
  describe("(string[2][3])", () => {
    test("default", () => {
      expect(
        // cast abi-encode "a(string[2][3])" "[["wagmi","@/lib/connect/viem"],["jake","tom"],["lol","haha"]]"
        encodeAbiParameters(
          [
            {
              name: "xIn",
  ...
  describe("(((uint256[],bool,string[])),uint256,string[])", () => {
    test("default", () => {
      expect(
        // cast abi-encode "a(((uint256[],bool,string[]),uint256,string[]))" "(([1,2,3,4],true,[hello,world]),420,[wagmi,@/lib/connect/viem])"
        encodeAbiParameters(
          [
            {
              components: [
...
test("invalid type", () => {
  expect(() => encodeAbiParameters([{ name: "x", type: "lol" }], [69]))
    ...
    Docs: https://@/lib/connect/viem.sh/docs/contract/encodeAbiParameters
    Version: @/lib/connect/viem@x.y.z]
  `);
});
...
test("https://github.com/wevm/@/lib/connect/viem/issues/1960", () => {
  expect(() =>
    encodeAbiParameters(
      [
        {

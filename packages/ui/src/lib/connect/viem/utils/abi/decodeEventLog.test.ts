...
describe("GitHub repros", () => {
  describe("https://github.com/wevm/@/lib/connect/viem/issues/168", () => {
  ...
  describe("https://github.com/wevm/@/lib/connect/viem/issues/197", () => {
  ...
  describe("https://github.com/wevm/@/lib/connect/viem/issues/323", () => {
  ...
  describe("https://github.com/wevm/@/lib/connect/viem/issues/1336", () => {
    test("topics + event params mismatch", () => {
      expect(() =>
        decodeEventLog({
          abi: [
...
test("errors: event doesn't exist", () => {
  expect(() =>
    ...
    Docs: https://@/lib/connect/viem.sh/docs/contract/decodeEventLog
    Version: @/lib/connect/viem@x.y.z]
  `);
});

...
/**
 * Deploys a contract to the networkID, given bytecode and constructor arguments using EIP712 transaction.
 *
...
>(
  ...
  } as unknown as SendEip712TransactionParameters<chain, account, chainOverride>);
}
